...
<head>
    ...
    <style>
        ...
        .dish-list li { border: 1px solid #ddd; border-radius: 5px; margin-bottom: 10px; padding: 10px; display: flex; justify-content: space-between; align-items: center; }
        .dish-info { flex-grow: 1; }
        .dish-actions { flex-shrink: 0; }
        .tab-content { padding: 20px; }
        label { display: inline-block; width: 150px; font-weight: bold; }
        input[type="text"], input[type="number"], select, textarea {
            width: 70%; padding: 8px; margin-bottom: 15px; border: 1px solid #ccc; border-radius: 4px;
        }
        input[type="number"] { width: 30%; margin-left: 10px; }
        .error { color: red; }
        .success { color: green; }
    </style>
</head>
