...
<head>
    ...
    <script>
        ...
        function openEditModal(button) {
            document.getElementById("updateOrderForm").action = "UpdateOrder?orderId=" + button.dataset.orderId;
        ...
        function addOrder() {
            ...
            var orderDate = $('#addOrderDate').val();
            var orderStatus = $('#addOrderStatus').val();
            var orderType = $('#addOrderType').val();
            var orderDescription = $('#addOrderDescription').val();
            var couponId = $('#addCouponId').val();
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response === "success") {
                        ...
                        alert('Failed to create order. Please check your input.');
                    }
                },
                error: function () {
                    // Nếu có lỗi, hiển thị thông báo lỗi
